...
public class CamelExplicitSplitter {
	...
	static Map<String, Set<String>> lastlistOfWrd = new HashMap<String, Set<String>>();
	...
	public static void idfyIdentifiers(String path) {
		...
		try {
			...
			/*
			 * Map<String, Set<String>> wlf = WordListCreater.wrdListForUnknownToken();
			 * wordList.putAll(wlf); lastlistOfWrd.putAll(wlf);
			 */
			WordListCreater.wrdListForUnknownToken();
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * @SuppressWarnings("rawtypes") Set set = wrdUnsplitUnknown.entrySet();//
		 * Converting toSet so that we can traverse
		 * 
